...
Several functions in the EatConscious package allow you to retrieve and visualize nutritional data of fresh produce items. This data is taken from the Food Database API  https://www.edamam.com. With these functions you can:  
